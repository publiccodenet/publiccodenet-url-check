...
<html lang="en">
  ...
  <title>css-unit-converter [![Build Status][ci-img]][ci], Foundation for Public Code repository link checks</title>
  ...
  <link rel="canonical" href="/publiccodenet-url-check/node_modules/css-unit-converter/">
...
<main>
 ...
 File an Issue</a></li>
  ...
  <article class="markdown-body">
    <h1 id="css-unit-converter-">css-unit-converter <a href="https://travis-ci.org/andyjansson/css-unit-converter"><img src="https://travis-ci.org/andyjansson/css-unit-converter.svg" alt="Build Status" /></a></h1>

<p>Converts CSS values from one unit to another</p>

<h2 id="installation">Installation</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">npm</span> <span class="nx">install</span> <span class="nx">css</span><span class="o">-</span><span class="nx">unit</span><span class="o">-</span><span class="nx">converter</span>
</code></pre></div></div>

<h2 id="usage">Usage</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">convert</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">css-unit-converter</span><span class="dl">'</span><span class="p">);</span>
<span class="c1">//convert 1 inch to pc</span>
<span class="nx">convert</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="dl">'</span><span class="s1">in</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">pc</span><span class="dl">'</span><span class="p">);</span> <span class="c1">// 6</span>

<span class="c1">//convert 10px to cm with a maximum of 10 decimals</span>
<span class="nx">convert</span><span class="p">(</span><span class="mi">10</span><span class="p">,</span> <span class="dl">'</span><span class="s1">px</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">cm</span><span class="dl">'</span><span class="p">,</span> <span class="mi">10</span><span class="p">);</span> <span class="c1">// 0.2645833333</span>
</code></pre></div></div>
