...
<html lang="en">
  ...
  <title>badge-maker, Repository link checks</title>
  ...
  <link rel="canonical" href="/publiccodenet-url-check/node_modules/badge-maker/">
...
<main>
 ...
 File an Issue</a></li>
  ...
  <article class="markdown-body">
    <h1 id="badge-maker">badge-maker</h1>

<p><a href="https://npmjs.org/package/badge-maker"><img src="https://img.shields.io/npm/v/badge-maker.svg" alt="npm version" /></a>
<a href="https://npmjs.org/package/badge-maker"><img src="https://img.shields.io/npm/l/badge-maker.svg" alt="npm license" /></a>
<a href="https://npmjs.org/package/badge-maker"><img src="https://img.shields.io/npm/types/badge-maker" alt="npm type definitions" /></a></p>

<h2 id="installation">Installation</h2>

<div class="language-sh highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm <span class="nb">install </span>badge-maker
</code></pre></div></div>
...
<div class="language-sh highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm <span class="nb">install</span> <span class="nt">-g</span> badge-maker
badge build passed :brightgreen <span class="o">&gt;</span> mybadge.svg
</code></pre></div></div>

<h3 id="as-a-library">As a library</h3>

<p>With CommonJS in JavaScript,</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="p">{</span> <span class="nx">makeBadge</span><span class="p">,</span> <span class="nx">ValidationError</span> <span class="p">}</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">badge-maker</span><span class="dl">'</span><span class="p">)</span>
</code></pre></div></div>

<p>With ESM or TypeScript,</p>

<div class="language-ts highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">import</span> <span class="p">{</span> <span class="nx">makeBadge</span><span class="p">,</span> <span class="nx">ValidationError</span> <span class="p">}</span> <span class="k">from</span> <span class="dl">'</span><span class="s1">badge-maker</span><span class="dl">'</span>
</code></pre></div></div>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">format</span> <span class="o">=</span> <span class="p">{</span>
  ...
  <span class="na">color</span><span class="p">:</span> <span class="dl">'</span><span class="s1">brightgreen</span><span class="dl">'</span><span class="p">,</span>
<span class="p">}</span>

<span class="kd">const</span> <span class="nx">svg</span> <span class="o">=</span> <span class="nx">makeBadge</span><span class="p">(</span><span class="nx">format</span><span class="p">)</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">svg</span><span class="p">)</span> <span class="c1">// &lt;svg...</span>

<span class="k">try</span> <span class="p">{</span>
  <span class="nx">makeBadge</span><span class="p">({})</span>
<span class="p">}</span> <span class="k">catch</span> <span class="p">(</span><span class="nx">e</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">e</span><span class="p">)</span> <span class="c1">// ValidationError: Field `message` is required</span>
<span class="p">}</span>
</code></pre></div></div>

<h3 id="node-version-support">Node version support</h3>

<p>The latest version of badge-maker supports all currently maintained Node
versions. See the <a href="https://github.com/nodejs/Release#release-schedule">Node Release Schedule</a>.</p>
...
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="p">{</span>
  <span class="nl">label</span><span class="p">:</span> <span class="dl">'</span><span class="s1">build</span><span class="dl">'</span><span class="p">,</span>  <span class="c1">// (Optional) Badge label</span>
  <span class="nx">message</span><span class="p">:</span> <span class="dl">'</span><span class="s1">passed</span><span class="dl">'</span><span class="p">,</span>  <span class="c1">// (Required) Badge message</span>
  <span class="nx">labelColor</span><span class="p">:</span> <span class="dl">'</span><span class="s1">#555</span><span class="dl">'</span><span class="p">,</span>  <span class="c1">// (Optional) Label color</span>
  <span class="nx">color</span><span class="p">:</span> <span class="dl">'</span><span class="s1">#4c1</span><span class="dl">'</span><span class="p">,</span>  <span class="c1">// (Optional) Message color</span>
  <span class="nx">logoBase64</span><span class="p">:</span> <span class="dl">'</span><span class="s1">data:image/svg+xml;base64,</span><span class="dl">'</span> <span class="c1">// (Optional) Any custom logo can be passed in a URL parameter by base64 encoding</span>
  <span class="nx">links</span><span class="p">:</span> <span class="p">[</span><span class="dl">'</span><span class="s1">https://example.com</span><span class="dl">'</span><span class="p">,</span> <span class="dl">'</span><span class="s1">https://example.com</span><span class="dl">'</span><span class="p">],</span> <span class="c1">// (Optional) Links array of maximum two links</span>

  <span class="c1">// (Optional) One of: 'plastic', 'flat', 'flat-square', 'for-the-badge' or 'social'</span>
  <span class="c1">// Each offers a different visual design.</span>
  <span class="nx">style</span><span class="p">:</span> <span class="dl">'</span><span class="s1">flat</span><span class="dl">'</span><span class="p">,</span>

  <span class="c1">// (Optional) A string with only letters, numbers, -, and _. This can be used</span>
  <span class="c1">// to ensure every element id within the SVG is unique and prevent CSS</span>
  <span class="c1">// cross-contamination when the SVG badge is rendered inline in HTML pages.</span>
  <span class="nx">idSuffix</span><span class="p">:</span> <span class="dl">'</span><span class="s1">dd</span><span class="dl">'</span>
<span class="p">}</span>
</code></pre></div></div>

<h2 id="colors">Colors</h2>

<p>There are three ways to specify <code class="language-plaintext highlighter-rouge">color</code> and <code class="language-plaintext highlighter-rouge">labelColor</code>:</p>

<ol>
  <li>One of the <a href="/publiccodenet-url-check/node_modules/badge-maker/lib/color.js">Shields named colors</a>:</li>
</ol>

<ul>
  <li><img src="https://img.shields.io/badge/brightgreen-brightgreen.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/green-green.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/yellow-yellow.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/yellowgreen-yellowgreen.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/orange-orange.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/red-red.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/blue-blue.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/grey-grey.svg" alt="" /> <img src="https://img.shields.io/badge/gray-gray.svg" alt="" /> – the default <code class="language-plaintext highlighter-rouge">labelColor</code></li>
  <li>
    <p><img src="https://img.shields.io/badge/lightgrey-lightgrey.svg" alt="" /> <img src="https://img.shields.io/badge/lightgray-lightgray.svg" alt="" /> – the default <code class="language-plaintext highlighter-rouge">color</code></p>
  </li>
  <li><img src="https://img.shields.io/badge/success-success.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/important-important.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/critical-critical.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/informational-informational.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/inactive-inactive.svg" alt="" /> – the default <code class="language-plaintext highlighter-rouge">color</code></li>
</ul>

<ol>
  <li>A three- or six-character hex color, optionally prefixed with <code class="language-plaintext highlighter-rouge">#</code>:</li>
</ol>

<ul>
  <li><img src="https://img.shields.io/badge/9cf-9cf.svg" alt="" /></li>
  <li><img src="https://img.shields.io/badge/%23007fff-007fff.svg" alt="" /></li>
  <li>etc.</li>
</ul>

<ol>
  <li><a href="https://developer.mozilla.org/en-US/docs/Web/CSS/color_value">Any valid CSS color</a>, e.g.</li>
</ol>

<ul>
  <li><code class="language-plaintext highlighter-rouge">rgb(...)</code>, <code class="language-plaintext highlighter-rouge">rgba(...)</code></li>
  <li><code class="language-plaintext highlighter-rouge">hsl(...)</code>, <code class="language-plaintext highlighter-rouge">hsla(...)</code></li>
  <li><img src="https://img.shields.io/badge/aqua-aqua.svg" alt="" /> <img src="https://img.shields.io/badge/fuchsia-fuchsia.svg" alt="" /> <img src="https://img.shields.io/badge/lightslategray-lightslategray.svg" alt="" /> etc.</li>
</ul>

<h2 id="raster-formats">Raster Formats</h2>

<p>Conversion to raster formats is no longer directly supported. In javascript
code, SVG badges can be converted to raster formats using a library like
<a href="https://www.npmjs.com/package/gm">gm</a>. On the console, the output of <code class="language-plaintext highlighter-rouge">badge</code>
can be piped to a utility like
<a href="https://imagemagick.org/script/command-line-processing.php">imagemagick</a>
e.g: <code class="language-plaintext highlighter-rouge">badge build passed :green | magick svg:- gif:-</code>.</p>
