...
<html lang="en">
  ...
  <title>binary-search, Foundation for Public Code repository link checks</title>
  ...
  <link rel="canonical" href="/publiccodenet-url-check/node_modules/binary-search/">
...
<p>This is a really tiny, stupid, simple binary search library for Node.JS. We
wrote it because existing solutions were bloated and incorrect.</p>

<p>This version is a straight port of the Java version mentioned by Joshua Bloch
in his article, <a href="http://googleresearch.blogspot.com/2006/06/extra-extra-read-all-about-it-nearly.html">Nearly All Binary Searches and Merge Sorts are Broken</a>.</p>

<p>Thanks to <a href="https://github.com/ConradIrwin">Conrad Irwin</a> and <a href="https://github.com/mgmarino">Michael
Marino</a> for, ironically, pointing out bugs.</p>

<h2 id="example">Example</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">bs</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">"</span><span class="s2">binary-search</span><span class="dl">"</span><span class="p">);</span>

<span class="nx">bs</span><span class="p">([</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">,</span> <span class="mi">3</span><span class="p">,</span> <span class="mi">4</span><span class="p">],</span> <span class="mi">3</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">element</span><span class="p">,</span> <span class="nx">needle</span><span class="p">)</span> <span class="p">{</span> <span class="k">return</span> <span class="nx">element</span> <span class="o">-</span> <span class="nx">needle</span><span class="p">;</span> <span class="p">});</span>
<span class="c1">// =&gt; 2</span>

<span class="nx">bs</span><span class="p">([</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">,</span> <span class="mi">4</span><span class="p">,</span> <span class="mi">5</span><span class="p">],</span> <span class="mi">3</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">element</span><span class="p">,</span> <span class="nx">needle</span><span class="p">)</span> <span class="p">{</span> <span class="k">return</span> <span class="nx">element</span> <span class="o">-</span> <span class="nx">needle</span><span class="p">;</span> <span class="p">});</span>
<span class="c1">// =&gt; -3</span>
</code></pre></div></div>

<p>Be advised that passing in a comparator function is <em>required</em>. Since you’re
probably using one for your sort function anyway, this isn’t a big deal.</p>

<p>The comparator takes a 1st and 2nd argument of element and needle, respectively.</p>

<p>The comparator also takes a 3rd and 4th argument, the current index and array,
respectively. You shouldn’t normally need the index or array to compare values,
but it’s there if you do.</p>

<p>You may also, optionally, specify an input range as the final two parameters,
...
<p>To the extent possible by law, The Dark Sky Company, LLC has <a href="http://creativecommons.org/publicdomain/zero/1.0/">waived all
copyright and related or neighboring rights</a> to this library.</p>
