...
<html lang="en">
  ...
  <title>color-convert, Foundation for Public Code repository link checks</title>
  ...
  <link rel="canonical" href="/publiccodenet-url-check/node_modules/color-convert/">
...
<main>
 ...
 File an Issue</a></li>
  ...
  <article class="markdown-body">
    <h1 id="color-convert-">color-convert <a href="https://travis-ci.org/harthur/color-convert"><img src="https://travis-ci.org/harthur/color-convert.svg?branch=master" alt="Build Status" /></a></h1>
<p>Color-convert is a color conversion library for JavaScript and node. It converts all ways between <code class="language-plaintext highlighter-rouge">rgb</code>, <code class="language-plaintext highlighter-rouge">hsl</code>, <code class="language-plaintext highlighter-rouge">hsv</code>, <code class="language-plaintext highlighter-rouge">hwb</code>, <code class="language-plaintext highlighter-rouge">cmyk</code>, and CSS keywords:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">converter</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">"</span><span class="s2">color-convert</span><span class="dl">"</span><span class="p">)();</span>

<span class="nx">converter</span><span class="p">.</span><span class="nx">rgb</span><span class="p">(</span><span class="mi">140</span><span class="p">,</span> <span class="mi">200</span><span class="p">,</span> <span class="mi">100</span><span class="p">).</span><span class="nx">hsl</span><span class="p">()</span>   <span class="c1">// [96, 48, 59]</span>

<span class="nx">converter</span><span class="p">.</span><span class="nx">keyword</span><span class="p">(</span><span class="dl">"</span><span class="s2">blue</span><span class="dl">"</span><span class="p">).</span><span class="nx">rgb</span><span class="p">()</span>      <span class="c1">// [0, 0, 255]</span>
</code></pre></div></div>

<h1 id="install">Install</h1>

<div class="language-console highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="go">npm install color-convert
</span></code></pre></div></div>

<h1 id="api">API</h1>

<p>Color-convert exports a converter object with getter/setter methods for each color space. It caches conversions:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">converter</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">"</span><span class="s2">color-convert</span><span class="dl">"</span><span class="p">)();</span>

<span class="nx">converter</span><span class="p">.</span><span class="nx">rgb</span><span class="p">(</span><span class="mi">140</span><span class="p">,</span> <span class="mi">200</span><span class="p">,</span> <span class="mi">100</span><span class="p">).</span><span class="nx">hsl</span><span class="p">()</span>   <span class="c1">// [96, 48, 59]</span>

<span class="nx">converter</span><span class="p">.</span><span class="nx">rgb</span><span class="p">([</span><span class="mi">140</span><span class="p">,</span> <span class="mi">200</span><span class="p">,</span> <span class="mi">100</span><span class="p">])</span>       <span class="c1">// args can be an array</span>
</code></pre></div></div>

<h3 id="plain-functions">Plain functions</h3>
<p>Get direct conversion functions with no fancy objects:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">require</span><span class="p">(</span><span class="dl">"</span><span class="s2">color-convert</span><span class="dl">"</span><span class="p">).</span><span class="nx">rgb2hsl</span><span class="p">([</span><span class="mi">140</span><span class="p">,</span> <span class="mi">200</span><span class="p">,</span> <span class="mi">100</span><span class="p">]);</span>   <span class="c1">// [96, 48, 59]</span>
</code></pre></div></div>

<h3 id="unrounded">Unrounded</h3>
<p>To get the unrounded conversion, append <code class="language-plaintext highlighter-rouge">Raw</code> to the function name:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">convert</span><span class="p">.</span><span class="nx">rgb2hslRaw</span><span class="p">([</span><span class="mi">140</span><span class="p">,</span> <span class="mi">200</span><span class="p">,</span> <span class="mi">100</span><span class="p">]);</span>   <span class="c1">// [95.99999999999999, 47.619047619047606, 58.82352941176471]</span>
</code></pre></div></div>

<h3 id="hash">Hash</h3>
<p>There’s also a hash of the conversion functions keyed first by the “from” color space, then by the “to” color space:</p>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">convert</span><span class="p">[</span><span class="dl">"</span><span class="s2">hsl</span><span class="dl">"</span><span class="p">][</span><span class="dl">"</span><span class="s2">hsv</span><span class="dl">"</span><span class="p">]([</span><span class="mi">160</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">20</span><span class="p">])</span> <span class="o">==</span> <span class="nx">convert</span><span class="p">.</span><span class="nx">hsl2hsv</span><span class="p">([</span><span class="mi">160</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">20</span><span class="p">])</span>
</code></pre></div></div>

<h3 id="other-spaces">Other spaces</h3>

<p>There are some conversions from rgb (sRGB) to XYZ and LAB too, available as <code class="language-plaintext highlighter-rouge">rgb2xyz()</code>, <code class="language-plaintext highlighter-rouge">rgb2lab()</code>, <code class="language-plaintext highlighter-rouge">xyz2rgb()</code>, and <code class="language-plaintext highlighter-rouge">xyz2lab()</code>.</p>

<h1 id="contribute">Contribute</h1>

<p>Please fork, add conversions, figure out color profile stuff for XYZ, LAB, etc. This is meant to be a basic library that can be used by other libraries to wrap color calculations in some cool way.</p>
