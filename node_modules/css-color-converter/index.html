...
<html lang="en">
  ...
  <title>css-color-converter [![Build Status][ci-img]][ci], Foundation for Public Code repository link checks</title>
  ...
  <link rel="canonical" href="/publiccodenet-url-check/node_modules/css-color-converter/">
...
<main>
 ...
 File an Issue</a></li>
  ...
  <article class="markdown-body">
    <h1 id="css-color-converter-">css-color-converter <a href="https://travis-ci.org/andyjansson/css-color-converter"><img src="https://travis-ci.org/andyjansson/css-color-converter.svg" alt="Build Status" /></a></h1>

<p>Converts CSS colors from one representation to another</p>

<h2 id="installation">Installation</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">npm</span> <span class="nx">install</span> <span class="nx">css</span><span class="o">-</span><span class="nx">color</span><span class="o">-</span><span class="nx">converter</span>
</code></pre></div></div>

<h2 id="usage">Usage</h2>

<p><strong>Example usage</strong>:</p>
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">import</span> <span class="p">{</span> <span class="nx">fromString</span> <span class="p">}</span> <span class="k">from</span> <span class="dl">'</span><span class="s1">css-color-converter</span><span class="dl">'</span><span class="p">;</span>

<span class="nx">fromString</span><span class="p">(</span><span class="dl">'</span><span class="s1">rgb(255, 255, 255)</span><span class="dl">'</span><span class="p">).</span><span class="nx">toHslString</span><span class="p">();</span> <span class="c1">// hsl(0, 0%, 100%)</span>
<span class="nx">fromString</span><span class="p">(</span><span class="dl">'</span><span class="s1">rgba(255, 255, 255, 0.5)</span><span class="dl">'</span><span class="p">).</span><span class="nx">toHslString</span><span class="p">();</span> <span class="c1">// hsla(0, 0%, 100%, 0.5)</span>
<span class="nx">fromString</span><span class="p">(</span><span class="dl">'</span><span class="s1">blue</span><span class="dl">'</span><span class="p">).</span><span class="nx">toRgbString</span><span class="p">();</span> <span class="c1">// rgb(0, 0, 255)</span>
<span class="nx">fromString</span><span class="p">(</span><span class="dl">'</span><span class="s1">red</span><span class="dl">'</span><span class="p">).</span><span class="nx">toHexString</span><span class="p">();</span> <span class="c1">// #ff0000</span>
</code></pre></div></div>
<h2 id="functions">Functions</h2>

<h3 id="fromstringstr"><code class="language-plaintext highlighter-rouge">fromString(str)</code></h3>
<p>| parameter | type   | description                                    |
| ——— | —— | ———————————————- |
| <code class="language-plaintext highlighter-rouge">str</code>     | string | Supports named colors, hex, rgb/rgba, hsl/hsla |</p>

<p><strong>Returns</strong> <a href="#Methods"><code class="language-plaintext highlighter-rouge">instance</code></a> if valid, <code class="language-plaintext highlighter-rouge">null</code> if invalid.</p>

<h3 id="fromrgbr-g-b"><code class="language-plaintext highlighter-rouge">fromRgb([r, g, b])</code></h3>
...
<p><strong>Returns</strong> <a href="#Methods"><code class="language-plaintext highlighter-rouge">instance</code></a></p>

<h3 id="fromrgbar-g-b-a"><code class="language-plaintext highlighter-rouge">fromRgba([r, g, b, a])</code></h3>
...
<h3 id="fromhslh-s-l"><code class="language-plaintext highlighter-rouge">fromHsl([h, s, l])</code></h3>
...
<h3 id="fromhslah-s-l-a"><code class="language-plaintext highlighter-rouge">fromHsla([h, s, l, a])</code></h3>
...
<h3 id="torgbstring"><code class="language-plaintext highlighter-rouge">toRgbString()</code></h3>

<p><strong>Returns</strong> <code class="language-plaintext highlighter-rouge">rgb()</code> or <code class="language-plaintext highlighter-rouge">rgba()</code>, depending on the alpha.</p>

<h3 id="tohslstring"><code class="language-plaintext highlighter-rouge">toHslString()</code></h3>

<p><strong>Returns</strong> <code class="language-plaintext highlighter-rouge">hsl()</code> or <code class="language-plaintext highlighter-rouge">hsla()</code>, depending on the alpha.</p>

<h3 id="tohexstring"><code class="language-plaintext highlighter-rouge">toHexString()</code></h3>

<p><strong>Returns</strong> 6-digit or 8-digit <code class="language-plaintext highlighter-rouge">hex</code>, depending on the alpha.</p>

<h3 id="torgbaarray"><code class="language-plaintext highlighter-rouge">toRgbaArray()</code></h3>

<p><strong>Returns</strong> <code class="language-plaintext highlighter-rouge">[r, g, b, a]</code> array.</p>
