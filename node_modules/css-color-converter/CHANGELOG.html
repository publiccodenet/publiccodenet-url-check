...
<html lang="en">
  ...
  <title>2.0.0 - 2020-09-24, Foundation for Public Code repository link checks</title>
  ...
  <link rel="canonical" href="/publiccodenet-url-check/node_modules/css-color-converter/CHANGELOG.html">
...
<main>
 ...
 File an Issue</a></li>
  ...
  <article class="markdown-body">
    <h1 id="200---2020-09-24">2.0.0 - 2020-09-24</h1>
<ul>
  <li>Rewrite as ES module. Some breaking changes to the API surface has been made as a result.</li>
  <li>Better adhere to CSS specification (#4).</li>
  <li>Add support for CSS Color Module Level 4 syntax.</li>
  <li>Update dependencies.</li>
  <li>Add eslint.</li>
  <li>Add babel.</li>
</ul>

<h1 id="111---2020-03-20">1.1.1 - 2020-03-20</h1>
<ul>
  <li>Fix alpha 0 incorrectly defaulting to 1 (#2). Thanks to jedwards1211.</li>
</ul>

<h1 id="110---2016-08-13">1.1.0 - 2016-08-13</h1>
<ul>
  <li>Add <code class="language-plaintext highlighter-rouge">toHslaArray</code> method.</li>
</ul>

<h1 id="102---2015-05-27">1.0.2 - 2015-05-27</h1>
<ul>
  <li>Fix typo causing <code class="language-plaintext highlighter-rouge">rgba()</code> to return incorrect results.</li>
</ul>

<h1 id="101---2015-05-27">1.0.1 - 2015-05-27</h1>
<ul>
  <li>Fix <code class="language-plaintext highlighter-rouge">toHexString()</code> not padding values.</li>
</ul>

<h1 id="100---2015-05-27">1.0.0 - 2015-05-27</h1>
<ul>
