...
<html lang="en">
  ...
  <title>anafanafo, Foundation for Public Code repository link checks</title>
  ...
  <link rel="canonical" href="/publiccodenet-url-check/node_modules/anafanafo/">
...
<main>
 ...
 File an Issue</a></li>
  ...
  <article class="markdown-body">
    <h1 id="anafanafo">anafanafo</h1>

<p><a href="https://npmjs.com/anafanafo"><img src="https://img.shields.io/npm/v/anafanafo?style=flat-square" alt="version" /></a>
<a href="https://npmjs.com/anafanafo"><img src="https://img.shields.io/npm/l/anafanafo?style=flat-square" alt="license" /></a>
<a href="https://circleci.com/gh/metabolize/anafanafo/tree/main"><img src="https://img.shields.io/circleci/project/github/metabolize/anafanafo/main?style=flat-square" alt="build" /></a>
<a href="https://bundlephobia.com/result?p=anafanafo"><img src="https://img.shields.io/bundlephobia/minzip/anafanafo?style=flat-square" alt="bundle size" /></a>
<a href="https://prettier.io/"><img src="https://img.shields.io/badge/code_style-prettier-ff69b4?style=flat-square" alt="code style" /></a>
<a href="https://lernajs.io/"><img src="https://img.shields.io/badge/maintained%20with-lerna-cc00ff?style=flat-square" alt="lerna" /></a></p>

<p>Efficiently compute text width in Verdana and Helvetica using
<a href="https://www.npmjs.com/package/char-width-table-consumer">char-width-table-consumer</a> and lookup tables.</p>

<p>Built with <a href="https://github.com/badges/shields/">Shields</a> in mind.</p>

<p>(And because Verdana always makes me think of <a href="https://www.youtube.com/watch?v=5MJLi5_dyn0">this</a>.)</p>

<h2 id="usage">Usage</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="nx">anafanafo</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">anafanafo</span><span class="dl">'</span><span class="p">)</span>

<span class="c1">// Supports '11px Verdana', '10px Verdana', 'bold 10px Verdana', and 'bold 11px Helvetica'.</span>
<span class="kd">const</span> <span class="nx">width</span> <span class="o">=</span> <span class="nx">anafanafo</span><span class="p">(</span><span class="dl">'</span><span class="s1">Shirley Shirley</span><span class="dl">'</span><span class="p">,</span> <span class="p">{</span> <span class="na">font</span><span class="p">:</span> <span class="dl">'</span><span class="s1">11px Verdana</span><span class="dl">'</span> <span class="p">})</span>
</code></pre></div></div>

<h2 id="license">License</h2>

<p>All rights to Verdana are owned by Microsoft Corp.</p>

<p>The remainder of this project is licensed under the MIT license.</p>
